...
def search_by_hashtag(hashtag= 'lamborghini'):
    global browser
    ...
    for url in urls:
        browser.get(url)
        time.sleep(random.randrange(2, 5))
        like = browser.find_element(By.XPATH, "/html/body/div[2]/div/div/div[2]/div/div/div[1]/div/div[3]/div/div/div/div/div[2]/div/article/div/div[2]/div/div/div[2]/section[1]/span[4]/div/div/button")
        like.click()
